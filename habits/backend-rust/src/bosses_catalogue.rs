...
pub struct BossDef {
    ...
    /// Durability lost per equipped item on each boss-day. Light and tier-scaled
    /// so a fight never one-shots a full set — wear is a tax, the unique item
    /// drop is the real payoff.
    pub wear_per_day: u32,
    pub reward_gold: f64,
